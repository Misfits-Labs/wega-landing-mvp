            ...
            <MainContainer>
                <div tw='flex flex-col items-center justify-center text-center w-full ml-20 md:ml-0'>
                    <div tw='text-center items-center justify-center'><h1 tw='text-white font-bold text-[67px] text-center h-[169px] font-primary ml-8 md:ml-0 hidden md:block'>Your NFTs' Favourite<br />Playground<span tw='text-[67px] dark:text-oranjo '>.</span></h1>
                        <h1 tw='text-white font-bold text-[67px] text-center h-[68px] font-primary flex md:hidden mb-[100px] w-full'>Your NFTs' Playground.</h1></div>
                    ...
                    <Section direction='col' hdr={<WordCarousel pre="Every asset can sit at this table" className='mt-[1434px] text-[38px]' fontSize={51} words={[
                        ...
                        <div tw='flex flex-col md:flex-row gap-[54px] h-[370px] justify-center items-center mt-44 md:mt-0'>
                            <div tw='flex flex-col items-center gap-[24px]  h-full w-[50%]'>
                                <div tw='h-[200px] w-full flex items-center justify-around mb-[-60px] md:mb-0'>
                                ...
                                <p tw='text-[21px] h-[60px] md:h-[19px] font-primary text-center'>Place a bet using approved tokens</p>
                            </div>
                            ...
                            <div tw='flex flex-col items-center gap-[24px]  h-full w-[50%]'>
                                ...
                                <p tw='text-[21px] h-[19px] font-primary mt-8 mb-8 md:mt-0 md:mb-0'>Use your NFT or play with fractions</p>
                            </div>
                        </div>
                    </Section><div tw='mt-44 md:mt-0'>
                        <Section direction='col' hdr={<WordCarousel pre='Play Hard, Own the Yard' fontSize={51} words={[""]} />}>
                            <div tw='flex flex-col text-center mt-20 md:mt-0'>
