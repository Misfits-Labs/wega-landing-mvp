        ...
        <>
            ...
            <MainContainer>
                <div tw='flex flex-col items-center justify-center text-center w-full'>
                    <h1 tw='text-white font-bold text-[67px] text-center h-[169px] font-primary hidden md:block mr-8'>Your NFTs' Favourite<br />Playground<span tw='text-[67px] dark:text-oranjo '>.</span></h1>
