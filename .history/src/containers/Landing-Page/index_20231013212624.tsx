...
const LandingPage = () => {
    return (
        <>
            ...
            <MainContainer>
                <div tw='flex flex-col items-center justify-center text-center w-full ml-24 md:ml-0'>
                    <div tw='text-center items-center justify-center'><h1 tw='text-white font-bold text-[67px] text-center ml-20 h-[169px] font-primary ml-8 md:ml-0 hidden md:block'>Your NFTs' Favourite<br />Playground<span tw='text-[67px] dark:text-oranjo '>.</span></h1>
