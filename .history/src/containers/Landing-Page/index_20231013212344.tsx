...
const LandingPage = () => {
    return (
        <>
            ...
            <MainContainer>
                <div tw='flex flex-col items-center justify-center text-center w-full ml-10'>
                    <h1 tw='text-white font-bold text-[67px] text-center h-[169px] font-primary ml-8 md:ml-0 hidden md:block'>Your NFTs' Favourite<br />Playground<span tw='text-[67px] dark:text-oranjo '>.</span></h1>
                    <h1 tw='text-white font-bold text-[67px] text-start h-[68px] font-primary flex md:hidden mb-[100px] w-full'>Your NFTs' Playground.</h1>
                ...
                <div tw='inline-flex flex-col items-center gap-[115px]'>
                    <ColorfulBanner />
