...
const FooterMobile = () => {
  ...
  return (
    <footer tw="relative z-[0] w-full">
      ...
      <div tw="container dark:text-blanc mt-5 flex flex-col w-full py-[56px] font-primary gap-y-[30px] justify-center items-center">
            ...
            <div tw="flex flex-col gap-x-[15px] items-center">
              ...
              <Link to="https://app.wega.fun/#/" target="_blank">
                <NormalText tw="text-transparent dark:bg-gradient-to-r from-oranjo-blanc to-oranjo  bg-clip-text" >Play Beta</NormalText>
              </Link>
            </div>
      </div> 
    </footer>
